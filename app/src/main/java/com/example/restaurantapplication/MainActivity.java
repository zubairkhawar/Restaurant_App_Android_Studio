...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantList.add(new Restaurant("Gloria Jeans", "Askari 11", "5678901234", "Description C", R.drawable.image3));
        restaurantList.add(new Restaurant("Wasabi", "DHA Y Block", "1234567890", "Description A", R.drawable.image4));
        restaurantList.add(new Restaurant("OD", "DHA Phase 3", "0987654321", "Description B", R.drawable.image5));
        restaurantList.add(new Restaurant("OPTP", "Girja Chowk", "5678901234", "Description C", R.drawable.image6));
